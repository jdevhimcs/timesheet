...
@endif
  ...
  <div class="form-group col-md-6">
     ...
     <optgroup label="{{$value->type}}">
          ...
          <div class="form-group col-md-12">
           ...
           @if(!empty($userdata->attachment))
            <br>
            <a href="{{ asset('/attachment/'.$userdata->attachment) }}" target="__blank">Click here</a> to view attachmnet.
          @endif
          </div>
        </div>
      </div>
    ...
    <div style="float:right;">
      <button type="button" id="prevBtn" class="btn btn-secondary btn-md" onclick="nextPrev(-1)">Previous</button>
      <button type="button" id="nextBtn" class="btn btn-dark btn-md" onclick="nextPrev(1)">Next</button>
    </div>
  </div>
