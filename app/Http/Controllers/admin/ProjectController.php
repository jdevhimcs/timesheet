...
class ProjectController extends Controller
{
    ...
    {
        $result=Project::orderBy('created_at', 'desc')->paginate('10');
    ...
    public function show($id)
    {
	   ...
	   $postedBy = User::find($project->added_by);
       return view('admin.projects.view',compact('providers','project','assined_users','assined_users_detail','postedBy'));
    }
